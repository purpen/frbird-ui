            ...
            callbacks: {
                ...
                onComplete: function(id, name, result, maybeXhr){
                    ...
                    if(!result.is_error){
                        ...
                        $.getJSON(that.options.fetchUploadURL, {'assets': result.data.ids, is_string: this.options.is_string, 'asset_type': that.options.assetType, 'asset_domain': that.options.assetDomain }, function(rs){
                            if(rs.is_error){
